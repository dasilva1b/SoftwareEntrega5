...
PROJECT_DIR, PROJECT_MODULE_NAME = os.path.split(
    os.path.dirname(os.path.realpath(ServiSoft.__file__))
)
...
DATABASES = {
    'default': {
        ...
        'NAME': 'servi22',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '*s4x_m%n_3c((+e-2mn^jbsn0$1xtmwcpgp7!7o*^k3$04a(de'
